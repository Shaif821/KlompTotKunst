...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <link rel="stylesheet" href="Stylesheet/Dashboard-stylsheet.css" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans" rel="stylesheet">
 </head>          
<!--
    <header>
        <h1>VAN <b>KLOMP</b> TOT <b>KUNST</b></h1> &nbsp; <img style="width: 15%; height:75px;" src="Stylesheet/Afbeeldingen/logo.png"><br>
         </header>
